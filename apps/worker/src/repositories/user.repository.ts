...
export async function findUserById(
  ...
  console.log(
    '[UserRepository] findUserById start:',
    id,
  );

  if (!ObjectId.isValid(id)) {
    console.log(
      '[UserRepository] invalid ObjectId',
    );
  ...
  console.log(
    '[UserRepository] collection obtained',
  );

  const objectId = new ObjectId(id);

  console.log(
    '[UserRepository] ObjectId created:',
    objectId.toString(),
  );

  console.log(
    '[UserRepository] calling findOne',
  );
  ...
  console.log(
    '[UserRepository] findOne completed:',
    Boolean(user),
  );
