/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1ca52b53c57cd60ca077cf020299ee13)
// Runtime types generated with workerd@1.20260815.1 2026-08-20 nodejs_compat
interface __BaseEnv_Env {
	ENVIRONMENT: "production";
	EMAIL_FROM: "NexChat <noreply@YOUR_VERIFIED_DOMAIN>";
	EMAIL_VERIFICATION_URL: "https://nexchat-sites.vercel.app/verify-email";
	MONGO_URI: string;
	JWT_SECRET: string;
	NEXCHAT_ROOM: DurableObjectNamespace<import("./src/index").NexChatRoom>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "NexChatRoom";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EMAIL_FROM" | "EMAIL_VERIFICATION_URL" | "MONGO_URI" | "JWT_SECRET">> {}
}
